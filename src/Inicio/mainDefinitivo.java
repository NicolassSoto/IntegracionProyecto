...
public class mainDefinitivo {
	...
	public static void main(String[] args) throws Exception {
		...
		Correlator correlatorCold = new Correlator(inputCorrelatorCold, correlatorColdOutput);

		List<Slot> inputCorrelatorHot = List.of(replicatorHotOutputToCorrelator, correlatorHotInput2);
		Correlator correlatorHot = new Correlator(inputCorrelatorHot, correlatorHotOutput);
